...
def enable_indications(%s):
    ...
    #otherwise just fall through for success''' % \
                (args,
                 CIMProvider2.enable_indications.__doc__ or "Doc Goes Here")
...
def disable_indications(%s):
    ...
    #otherwise just fall through for success''' % \
                (args,
                 CIMProvider2.disable_indications.__doc__ or "Doc Goes Here")
...
def deactivate_filter(%s):
    ...
    #otherwise just fall through for success''' % \
                (
                    args,
                    CIMProvider2.deactivate_filter.__doc__ or "Doc Goes Here")
